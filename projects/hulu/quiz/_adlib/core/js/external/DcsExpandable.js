...
var DcsExpandable = new function(){
	...
	/**	Method: collapse()
		...
		Parameters:
			gestureEvent  		- if `DcsExpandable.collapse` is passed as the callback to <Gesture>, then it will be assumed that this was a 
	...
	*/
	...
	/**	Method: linkMainContainers()
		...
		Parameters:
			collapsed 	- The collapsed container, should be called: adData.elements.stage.collapsedContainer
			expanded 	- The expanded container, should be called: adData.elements.stage.expandedContainer

		> DcsExpandable.linkMainContainers ( adData.elements.stage.collapsedContainer, adData.elements.stage.expandedContainer )
	*/
