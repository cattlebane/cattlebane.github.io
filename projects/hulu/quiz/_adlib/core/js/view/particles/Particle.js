...
Particle.prototype = {
    ...
    */
	render: function () {
		...
		this.graphic.render( this.ctx, style );
	},
	/** Method: applyForce()
    ...
    */
	...
	/** Method: isDead()
			Returns a boolean of is the particle is dead depending on two situations: 1. if it has reaches its lifespan, or
			 2. if it is out of the canvas and the killIfOutOfCanvas property in EmitterData is set to true
		Returns:
			Boolean
    */
	...
	/** Method: checkWorld()
        ...
        Parameters:
            w - an array that contains left X, right X, top Y, bottom Y as values for the boundary
    ...
    */
	...
	/** Method: _checkBorder()
        ...
        Parameters:
            axis - String 'x' or 'y'
            val - the location of the border on the X or Y axis
